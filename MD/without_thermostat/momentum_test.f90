module md_module
  implicit none
  integer,parameter:: npart= 1200, niter_eq=2000, niter=500000, n_calc_av=10
...
!steps for equilibrium
  ...
  do time=1,niter_eq+niter
     ...
     write(21,*) time, av_vx/npartf,av_vy/npartf,av_vz/npartf
     print*,"Iteration no >",time
  end do
  close(21)
  ! close(34 )
  ! close(35)
