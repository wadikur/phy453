module md_module
  implicit none
  integer,parameter:: npart= 1200, niter_eq=2000, niter=1000, n_calc_av=10
...
!steps for equilibrium
  ...
  do time=1,niter_eq
     ...
     write(36,*) time*delta_t,kinetic_energy+potential_energy
     write(35,*) time*delta_t,kinetic_energy
     write(34,*) time*delta_t,potential_energy
  ...
  do time=1,niter
     ...
     write(31,*) time*delta_t,kinetic_energy+potential_energy
     write(32,*) time*delta_t,kinetic_energy
     write(33,*) time*delta_t,potential_energy
  ...
  do time=1,niter/2
     ...
     call update_vel(delta_t)
     ! if (mod(time,n_calc_av)==0) call calc_thermodyn
     write(37,*) time*delta_t,kinetic_energy+potential_energy
     write(38,*) time*delta_t,kinetic_energy
     write(39,*) time*delta_t,potential_energy
  ...
  do time=1,2*niter
     ...
     call calc_force()
     call update_vel(delta_t)
     write(40,*) time*delta_t,kinetic_energy+potential_energy
     write(41,*) time*delta_t,kinetic_energy
     write(42,*) time*delta_t,potential_energy
    ! if (mod(time,n_calc_av)==0) call calc_thermodyn
  end do
  close(40)
  close(41)
