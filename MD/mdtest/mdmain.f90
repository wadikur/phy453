module md_module
  implicit none
  integer,parameter:: npart= 1200, niter_eq=5000, niter=5000, n_calc_av=10
  ...
  real*8,parameter:: sigma6=sigma**6,sigma12=sigma**12,epst4=4.0d0*eps
...
program MD
  ...
  implicit none
  integer:: time
  real*8:: initial_pos(3*npart),initial_vel(3*npart)
  real*8::delta_t
  ...
  ! open(50,file="initial_position.dat")
  ! open(51,file="initial_velocity.dat")
  ...
  ! open(100,file='initial_position.dat',status='old')
  ! do i=1,3*npart
  !    read(100,*)initial_pos(i)
  ! end do
  ! close(100)
  ! open(101,file='initial_velocity.dat',status='old')
  ! do i=1,3*npart
  !    read(101,*)initial_vel(i)
  ! end do
  ! close(101)
  ! pos=initial_pos
  ! vel=initial_vel
